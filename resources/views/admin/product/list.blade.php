...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <ul class="nav nav-pills flex-column flex-md-row mb-3">
    <button href="{{ route('nhacungcap.create')}}" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal">
      Thêm mới
    </button>
    {{-- <li class="nav-item">
        <a class="nav-link active" href=""><i class="bx bx-plus"></i> Thêm mới</a>
    </li> --}}
    <li class="nav-item "  style="margin-left: 10px;">
      <form action="" method="GET" class="form-search-custom">
