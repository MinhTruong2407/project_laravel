      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item">
                <a href="layouts-without-navbar.html" class="menu-link">
                  <div data-i18n="Without navbar">Danh Mục Sản Phẩm</div>
                </a>
              </li>
              <li class="menu-item">
          ...
          <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/products/list" class="menu-link active">
                    <div data-i18n="Without menu">Nhà Cung Cấp</div>
                  </a>
                </li>
                <li class="menu-item">
          ...
          <!-- Forms & Tables -->
          <li class="menu-header small text-uppercase"><span class="menu-header-text">Quản Lý Bán Hàng</span></li>
          <!-- Forms -->
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            {{-- <ul class="menu-sub">
              <li class="menu-item">
                <a href="forms-basic-inputs.html" class="menu-link">
                  <div data-i18n="Basic Inputs">Khuyến Mãi</div>
                </a>
              </li>
              <li class="menu-item">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div data-i18n="Form Layouts">Khuyến Mãi</div>
            </a>
            {{-- <ul class="menu-sub">
              <li class="menu-item">
